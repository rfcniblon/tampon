...
class Testconversion extends Component {
    render() {
        return (
            <>
           ...
           <div class="container">
              <div class="row">
                  <div class="col-md-12 bannierCenter"> 
                      <p class="tagbannier">Service client 6j/7 de 7h à 21h <span class="ti-headphone-alt mr-2"></span> <a href="tel:+33234401467">: 02.34.40.14.67</a></p>               
                  </div>
              </div>
          </div>
      </div> */}
